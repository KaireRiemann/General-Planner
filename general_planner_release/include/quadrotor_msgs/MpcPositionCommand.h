...
#if defined(_WIN32) && defined(NORMAL_COMMAND)
  #undef NORMAL_COMMAND
#endif
#if defined(_WIN32) && defined(BLOCK_COMMAND)
  #undef BLOCK_COMMAND
#endif
...
bool operator==(const ::quadrotor_msgs::MpcPositionCommand_<ContainerAllocator1> & lhs, const ::quadrotor_msgs::MpcPositionCommand_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    ...
    lhs.command_flag == rhs.command_flag;
}
...
struct MD5Sum< ::quadrotor_msgs::MpcPositionCommand_<ContainerAllocator> >
{
  ...
  {
    return "d5da74eb84dd86c3c380b221a8a0b6ae";
  }

  static const char* value(const ::quadrotor_msgs::MpcPositionCommand_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xd5da74eb84dd86c3ULL;
  static const uint64_t static_value2 = 0xc380b221a8a0b6aeULL;
};
...
"uint32 mpc_horizon\n"
"uint8 command_flag\n"
"uint8 NORMAL_COMMAND = 1\n"
"uint8 BLOCK_COMMAND = 137\n"
"\n"
"================================================================================\n"
"MSG: std_msgs/Header\n"
  ...
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::quadrotor_msgs::MpcPositionCommand_<ContainerAllocator>& v)
  {
    ...
    for (size_t i = 0; i < v.cmds.size(); ++i)
    {
      if (false && i > 0)
        ...
        s << std::endl << indent << "  -";
      Printer< ::quadrotor_msgs::PositionCommand_<ContainerAllocator> >::stream(s, false ? std::string() : indent + "    ", v.cmds[i]);
    }
    if (v.cmds.empty() || false)
      s << "]";
    if (true || !indent.empty())
    ...
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "command_flag: ";
    Printer<uint8_t>::stream(s, indent + "  ", v.command_flag);
  }
};
