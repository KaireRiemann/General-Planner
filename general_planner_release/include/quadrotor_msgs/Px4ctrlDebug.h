...
struct Px4ctrlDebug_
{
  ...
  _header_type header;
   ...
   typedef double _pid_P_pos_term_type;
  _pid_P_pos_term_type pid_P_pos_term;

   typedef double _pid_I_pos_term_type;
  _pid_I_pos_term_type pid_I_pos_term;

   typedef double _pid_P_vel_term_type;
  _pid_P_vel_term_type pid_P_vel_term;

   typedef double _des_p_x_land_type;
  _des_p_x_land_type des_p_x_land;

   typedef double _des_p_y_land_type;
  _des_p_y_land_type des_p_y_land;

   typedef double _des_p_z_land_type;
  _des_p_z_land_type des_p_z_land;
...
bool operator==(const ::quadrotor_msgs::Px4ctrlDebug_<ContainerAllocator1> & lhs, const ::quadrotor_msgs::Px4ctrlDebug_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    lhs.pid_P_pos_term == rhs.pid_P_pos_term &&
    lhs.pid_I_pos_term == rhs.pid_I_pos_term &&
    lhs.pid_P_vel_term == rhs.pid_P_vel_term &&
    lhs.des_p_x_land == rhs.des_p_x_land &&
    lhs.des_p_y_land == rhs.des_p_y_land &&
    lhs.des_p_z_land == rhs.des_p_z_land &&
...
struct MD5Sum< ::quadrotor_msgs::Px4ctrlDebug_<ContainerAllocator> >
{
  ...
  {
    return "b97bd027c46b8f8186f23bb3224a96ba";
  }

  static const char* value(const ::quadrotor_msgs::Px4ctrlDebug_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xb97bd027c46b8f81ULL;
  static const uint64_t static_value2 = 0x86f23bb3224a96baULL;
};
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::quadrotor_msgs::Px4ctrlDebug_<ContainerAllocator> >
  {
    template<typename Stream, typename T> inline static void allInOne(Stream& stream, T m)
    {
      ...
      stream.next(m.pid_P_pos_term);
      stream.next(m.pid_I_pos_term);
      stream.next(m.pid_P_vel_term);
      stream.next(m.des_p_x_land);
      stream.next(m.des_p_y_land);
      stream.next(m.des_p_z_land);
...
struct Printer< ::quadrotor_msgs::Px4ctrlDebug_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::quadrotor_msgs::Px4ctrlDebug_<ContainerAllocator>& v)
  {
    ...
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "pid_P_pos_term: ";
    Printer<double>::stream(s, indent + "  ", v.pid_P_pos_term);
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "pid_I_pos_term: ";
    Printer<double>::stream(s, indent + "  ", v.pid_I_pos_term);
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "pid_P_vel_term: ";
    Printer<double>::stream(s, indent + "  ", v.pid_P_vel_term);
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "des_p_x_land: ";
    Printer<double>::stream(s, indent + "  ", v.des_p_x_land);
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "des_p_y_land: ";
    Printer<double>::stream(s, indent + "  ", v.des_p_y_land);
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "des_p_z_land: ";
    Printer<double>::stream(s, indent + "  ", v.des_p_z_land);
    if (true || !indent.empty())
      s << std::endl;
    s << indent << "des_v_x: ";
