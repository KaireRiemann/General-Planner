...
"""autogenerated by genpy from tracking_detector/BoundingBoxes.msg. Do not edit."""
import codecs
import sys
...
================================================================================
MSG: tracking_detector/BoundingBox
float64 probability
int64 xmin
int64 ymin
int64 xmax
...
"""
  ...
  _slot_types = ['std_msgs/Header','std_msgs/Header','tracking_detector/BoundingBox[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = tracking_detector.msg.BoundingBox()
        _x = val1
        start = end
        end += 42
