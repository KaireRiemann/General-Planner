...
"""autogenerated by genpy from general_planner/PlannerModeRequest.msg. Do not edit."""
import codecs
import sys
...
class PlannerModeRequest(genpy.Message):
  _md5sum = "b7eb79981248a21660d0d5a0e979e9e7"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,request_id,task_id,mode
    ...
    """
    if args or kwds:
      super(PlannerModeRequest, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.request_id,) = _get_struct_Q().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
