...
protected:
    ...
    size_t radiusSearchNano(
        ...
        //  size_t n =  
       // nanoflann's L2 adaptor compares squared distances. Expose the ROS
       // parameter as an intuitive distance in metres.
       return kdPtr_->radiusSearch(
            check_pt.data(), radius * radius, ret_matches, params);
