...
void Parameter_t::config_from_ros_handle(const ros::NodeHandle &nh)
{
	...
	//kdkd land param
	read_essential_param(nh, "gain/Klandp0", gain.Klandp0);
	read_essential_param(nh, "gain/Klandp1", gain.Klandp1);
	read_essential_param(nh, "gain/Klandv0", gain.Klandv0);
	read_essential_param(nh, "gain/Klandv1", gain.Klandv1);

	read_essential_param(nh, "gain/Ip0", gain.Ip0);
	read_essential_param(nh, "gain/Ip1", gain.Ip1);
	read_essential_param(nh, "gain/Ip2", gain.Ip2);
	...
	//kdkd
	read_essential_param(nh, "auto_takeoff_land/at_home_land", takeoff_land.at_home_land);
	read_essential_param(nh, "duration_time_to_flight", duration_time_to_flight);
