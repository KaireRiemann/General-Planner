...
struct FrontierParam {
  ...
  int cluster_min_observation_frames_;
...
struct ClusterInfo {
  ...
  FrontierState state_;
  int observation_count_;
  int visible_fail_count_;
  int reachable_fail_count_;
  int selected_count_;
...
struct HighSpeedViewScoreContext {
  ...
  bool hard_gate_enable = true;
  double hard_gate_min_known_free_ratio = 1.0;
  double hard_gate_max_turn_angle = 1.40;
