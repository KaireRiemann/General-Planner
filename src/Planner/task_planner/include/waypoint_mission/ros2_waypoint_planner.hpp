#ifndef TASK_PLANNER_WAYPOINT_PLANNER
#define TASK_PLANNER_WAYPOINT_PLANNER
...
namespace task_planner {
    ...
    private:
        ...
        void RvizClickCallback(const geometry_msgs::msg::PoseStamped::SharedPtr msg) {
            ...
            waypoint_counter = 0;
            cout << YELLOW <<
                 " -- [TASK_PLANNER] Rviz triggered." << RESET << endl;
        }
        ...
        void MavrosRcCallback(const mavros_msgs::msg::RCIn::SharedPtr msg) {
            ...
            if (last_ch_10 > 1500 && ch_10 < 1500) {
                ...
                new_goal = true;
                waypoint_counter = 0;
                cout << YELLOW << " -- [TASK_PLANNER] Mavros triggered." << RESET << endl;
            }
            last_ch_10 = ch_10;
        }
        ...
        void GoalPubTimerCallback() {
            ...
            if (cfg_.start_trigger_type == 2 && !trigger_once) {
                ...
                if (cur_t - system_start_time < cfg_.start_program_delay) {
                    ...
                    cout << YELLOW << " -- [TASK_PLANNER] System start delay passed." << RESET << endl;
                    triggered = true;
                    trigger_once = true;
                }
            }
            ...
            if (cur_t - odom_rcv_time > cfg_.odom_timeout) {
                ...
                if (cur_t - last_print_t > 1.0) {
                    last_print_t = cur_t;
                    cout << YELLOW << " -- [TASK_PLANNER] Odom Timeout!" << RESET << endl;
                }
                return;
            }
            ...
            if (CloseToPoint(cfg_.waypoints[waypoint_counter], waypoint_counter)) {
                cout << RED << " -- [TASK_PLANNER] Close to goal {}, switch to next." << RESET << endl;
                waypoint_counter++;
                new_goal = true;
            ...
            if (new_goal || cur_t - last_pub_time > cfg_.publish_dt) {
                ...
                cout << YELLOW << " -- [TASK_PLANNER] Pub goal to " << cfg_.waypoints[waypoint_counter].transpose()
                     << RESET << endl;
...
#endif //TASK_PLANNER_WAYPOINT_PLANNER
