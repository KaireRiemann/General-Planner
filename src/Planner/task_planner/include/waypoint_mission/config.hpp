...
#ifndef TASK_PLANNER_CONFIG
#define TASK_PLANNER_CONFIG
...
namespace task_planner {
    ...
    public:
        ...
        void LoadWaypoint(string file_name) {
            ...
            cout << GREEN << " -- [TASK_PLANNER] Load " << waypoints.size() << " waypoints." << RESET << endl;
            for (int i = 0; i < waypoints.size(); i++) {
                cout << BLUE << " -- [TASK_PLANNER] Waypoint " << i << " at (" << waypoints[i].x() << ", "
